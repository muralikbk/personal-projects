##### Besides providing invoice finance, Company also runs a physical store which sells (only) 3 products:

``` 
Code         | Name                |  Price
-------------------------------------------------
VOUCHER      | Company Voucher      |   5.00€
TSHIRT       | Company T-Shirt      |  20.00€
MUG          | Company Coffee Mug   |   7.50€
```
...
Company's checkout process allows for items to be scanned in any order, and should return the total amount to be paid. The interface for the checkout process looks like this (ruby):
